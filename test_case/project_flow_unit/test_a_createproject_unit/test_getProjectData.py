...
test_data = DoExcel(project_path.case_path, 'getProjectData').read_excel('getProjectDataCASE')
My_log = Mylog()

@ddt
class GetProjectData(unittest.TestCase):
    def setUp(self):
        self.T = DoExcel(project_path.case_path, 'getProjectData')
    ...
    def test_getProjectData(self, case):
        '''查找项目ID和主项目ID的校验'''
