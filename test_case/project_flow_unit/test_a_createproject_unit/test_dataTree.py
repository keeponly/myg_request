...
test_data = DoExcel(project_path.case_path, 'dataTree').read_excel('dataTreeCASE')
My_log = Mylog()

@ddt
class DataTree(unittest.TestCase):
    def setUp(self):
        self.T = DoExcel(project_path.case_path, 'dataTree')
