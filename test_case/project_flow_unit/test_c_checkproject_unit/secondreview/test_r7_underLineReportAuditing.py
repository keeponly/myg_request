...
test_data = DoExcel(project_path.case_path, 'underLineReportAuditing').read_excel('underLineReportAuditingCASE3')
My_log = Mylog()
token = None
@ddt
class test_r3_underLineReportAuditing(unittest.TestCase):
    ...
    def test_r3_underLineReportAuditing(self, case):
        ...
        if "%" in param1:
            ...
            taskId6 = getattr(GetData, "taskId6")
            print("projectId:{},investorId:{},taskId6{}".format(projectId,investorId,taskId6))
            param1 = param1 % ({"projectId": projectId,"investorId":investorId,"taskId6":taskId6})
