...
#
# test_data = DoExcel(project_path.case_path, 'clickproject').read_excel('clickprojectCASE')
# My_log = Mylog()
# token = None
# @ddt
# class ClickProject(unittest.TestCase):
#     def setUp(self):
#         self.T = DoExcel(project_path.case_path, 'clickproject')
#
#     def tearDown(self):
#         pass
#
#     @data(*test_data)
#
#     def test_clickproject(self, case):
#         """点击项目的所有接口"""
